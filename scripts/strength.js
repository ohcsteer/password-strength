...
document.addEventListener("keyup", function(e) {
	...
	pass != "" ? document.getElementById("crack-time").textContent = "Cracked in " + strength.crack_times_display.offline_slow_hashing_1e4_per_second : document.getElementById("crack-time").textContent = "";
	/*
